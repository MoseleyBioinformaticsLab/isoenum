...
@pytest.mark.parametrize('path, parameters', [
    ...
    ('-a C-13 -s C-13-2 -e N-15', 'tests/example_data/bmse000040.mol'),
    ('-a C-13 -s C-13-2 -e N-15', 'tests/example_data/bmse000040.sdf'),
    ('-a C-13 -s C-13-2 -e N-15', 'tests/example_data/bmse000040.inchi'),
